...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"verana", "dd", "v1", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ListDIDs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"verana", "dd", "v1", "list"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_GetDID_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"verana", "dd", "v1", "get", "did"}, "", runtime.AssumeColonVerbOpt(true)))
)
