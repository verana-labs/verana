...
var (
	...
	ErrPermissionNotFound       = errors.Register(ModuleName, 1110, "permission not found")
	ErrPermissionFieldsNull     = errors.Register(ModuleName, 1111, "permission authority and vs_operator must not be null")
	ErrOperatorAuthzExistsMutex = errors.Register(ModuleName, 1112, "OperatorAuthorization already exists for this authority/vs_operator pair; mutual exclusivity violated")
	ErrPermKeeperRequired       = errors.Register(ModuleName, 1113, "permission keeper is required for VS operator authorization")
	ErrInvalidResponseMaxSize   = errors.Register(ModuleName, 1114, "response_max_size must be between 1 and 1024")
)
