...
var (
	...
	moduleAccPerms = []*authmodulev1.ModuleAccountPermission{
		...
		{Account: trmoduletypes.ModuleName, Permissions: []string{authtypes.Minter, authtypes.Burner}},
		{Account: tdmoduletypes.ModuleName, Permissions: []string{authtypes.Minter, authtypes.Burner}},
		{Account: permmoduletypes.ModuleName},
